...
module.exports = React.createClass({
	...
	render: function(){
		...
		return (
			<td className={znui.react.classname("zr-table-tcell", (_column.fixed?'fixed':''), this.props.className, _column.bodyClassName, this.state.className)} style={znui.react.style(this.props.style, _column.bodyStyle, this.state.style, _column.fixedStyles)}	
